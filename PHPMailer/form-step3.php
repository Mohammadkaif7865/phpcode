<?php $page ='home';
	...
	if(isset($_POST['next3'])){
		$_SESSION['roadworthy'] = $_POST['roadworthy'];
			...
			<div class="containerFull">
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<div id="myWizard">
							<div class="inlineProgress"><p class="title">Find out in less than 30 seconds</p><p class="title">Step 3/5</p></div>
							<div class="progress hideOnSubmit">
					          <div aria-valuemax="6" aria-valuemin="1" aria-valuenow="1" class="progress-bar progress-bar-success" role="progressbar" style="width: 60%;">
					          </div>
					      </div>
							<form  method="post" action="">
								<div class="formStep">
									<h2 class="heading fontWeight600 text-center mt-lg-5">Is your car still roadworthy?</h2>
									<div class="row">
									...
									<div class="mt-4">
					                  	<div class="checkBox threeItem">
											<ul>
												<li>
													<input type="radio" value="Yes" checked name="roadworthy" id="wales">
													<label for="wales">
														<p class="fontWeight500">Yes</p>
													</label>
												</li>
												<li>
													<input type="radio" value="No" name="roadworthy" id="scotland">
													<label for="scotland">
														<p class="fontWeight500">No</p>
													</label>
												</li>
												<li>
													<input type="radio" value="Not Sure" name="roadworthy" id="ireland">
													<label for="ireland">
										...
										<div class="mt-4 d-flex justify-content-between">
											<a href="form-step2.php" class="previousBtn"><i class="fa fa-chevron-left"></i> Previous</a>
											<button type="submit" name="next3" class="btnTheme mt-4 btnShadow">Next <i class="fa fa-chevron-right"></i></button>
										</div>
									</div>
								</div>
							</form>
